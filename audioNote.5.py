...
yt = YouTube('https://www.youtube.com/watch?v=fctH_1NuqCQ')
caption = yt.captions.get_by_language_code('en')
caption = caption.generate_srt_captions()
title = 'https://www.youtube.com/watch?v=YM-uykVfq_E'
...
allCaptions = open("allCaptions.txt", "w")
allCaptions.write(caption)


reduction = Reduction()
reduction_ratio = 0.3
reduced_text = reduction.reduce(caption, reduction_ratio)

summarized = open("summarized.txt", "w")
for line in reduced_text:
  # write line to output file
  summarized.write(line)
  summarized.write("\n" * 2)
summarized.close()